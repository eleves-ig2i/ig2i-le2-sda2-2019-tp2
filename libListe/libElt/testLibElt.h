/**
 * \file testLibElt.h
 * \brief Déclaration des fonctions de test de la bibliothèque libElt.
 * \remark Le test est fait avec des entiers.
 * \author Nathan Salez
 * \version 1.0
 * \date 18/09/2018
 */

#ifndef SDA2_TP2_SALEZ_NATHAN_TESTLIBELT_H
#define SDA2_TP2_SALEZ_NATHAN_TESTLIBELT_H
...
/**
 * \fn void testSaisieElt()
 * \brief test de la fonction void saisirElt(elt_t* e).
 * \author Nathan Salez
 * \version 1.0
 * \date 13/09/2018
 */
...
/**
 * \fn void testRangerElt()
 * \brief test de la fonction void rangerElt(elt_t* d, const elt_t* s).
 * \author Nathan Salez
 * \version 1.0
 * \date 13/09/2018
 */
...
/**
 * \fn void testAfficherElt()
 * \brief test de la fonction void void afficherElt(const elt_t* e).
 * \author Nathan Salez
 * \version 1.0
 * \date 13/09/2018
 */
...
#endif // SDA2_TP2_SALEZ_NATHAN_TESTLIBELT_H
